# -*- coding: utf-8 -*-
#
# iucm documentation build configuration file, created by
...
if not osp.exists(osp.join(osp.dirname(__file__), 'command_line')):
    import command_line_api
    command_line_api.main()
...
project = u'iucm'
copyright = u'2016, Philipp Sommer and Roger Cermades'
author = u'Philipp Sommer, Roger Cermades'
...
version = re.match('\d+\.\d+\.\d+', iucm.__version__).group()
# The full version, including alpha/beta/rc tags.
release = iucm.__version__
...
latex_documents = [
  (master_doc, 'iucm.tex', u'iucm Documentation',
...
man_pages = [
    (master_doc, 'iucm', u'iucm Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'iucm', u'iucm Documentation',
   author, 'iucm', 'The Integrated Urban Complexity Model',
   'Miscellaneous'),
]
